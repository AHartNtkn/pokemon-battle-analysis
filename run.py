...
from pages import index, predictions, insights, limitations, process
...
navbar = dbc.NavbarSimple(
    brand='Predicting the Winner of Pokémon Battles',
    brand_href='/', 
    children=[
        dbc.NavItem(dcc.Link('Predictions', href='/predictions', className='nav-link')), 
        dbc.NavItem(dcc.Link('Insights', href='/insights', className='nav-link')), 
        dbc.NavItem(dcc.Link('Limitations', href='/limitations', className='nav-link')), 
        dbc.NavItem(dcc.Link('Data and Model', href='/process', className='nav-link')), 
    ],
    sticky='top',
    color='primary', 
    light=True, 
...
footer = dbc.Container(
    dbc.Row(
        dbc.Col(
            html.P(
                [
                    html.Span('Anthony Hart', className='mr-2'), 
                    html.A(html.I(className='fas fa-envelope-square mr-1'), href='mailto:anthony.loren.hart@gmail.com'), 
                    html.A(html.I(className='fab fa-github-square mr-1'), href='https://github.com/AHartNtkn/pokemon-battle-analysis'), 
                    html.A(html.I(className='fab fa-linkedin mr-1'), href='https://www.linkedin.com/in/anthony-hart-841768193/'), 
...
def display_page(pathname):
    ...
    elif pathname == '/limitations':
        return limitations.layout
